...
<head>
    ...
    <!-- summernote -->
    <link rel="stylesheet" href="/backend-admin/plugins/summernote/summernote-bs4.min.css">
</head>
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="/assets/images/favicon.png" alt="Logo" height="60" width="60">
        </div>
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-sm-inline-block">
                    <span class="nav-link">Selamat Datang Kepala Bidang
                    </span>
                </li>
            </ul>
                ...
                <!-- <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item"> 
                            <div class="media">
                                <img src="/backend-admin/dist/img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
                        ...
                        <a href="#" class="dropdown-item"> 
                            <div class="media">
                                <img src="/backend-admin/dist/img/user8-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        John Pierce
                        ...
                        <a href="#" class="dropdown-item"> 
                            <div class="media">
                                <img src="/backend-admin/dist/img/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        Nora Silvester
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="/" class="brand-link">
                <img src="/assets/images/favicon.png" alt="Logo" class="brand-image">
                <span class="brand-text font-weight-light">Kepala Bidang</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="https://cdn-icons-png.flaticon.com/128/149/149071.png" alt="User Image">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block"> <?= esc($user['nama_users']); ?></a>
                    </div>
                </div>
        ...
        <footer class="main-footer text-sm">
            <strong>Copyright &copy; 2024 SIGPUKAN. </strong>
            All rights reserved.
